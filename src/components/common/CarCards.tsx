...
export default function CarCards({ handleCarSelect, car }: ISelectCarFunc) {
  ...
  return (
    <div className="rounded-xl shadow-md sm:mx-auto sm:w-[35rem] w-full sm:h-[19rem] relative bg-red-200">
      <img
        src={image as string}
        alt="Car"
        className="w-full h-full object-fill rounded-lg p-3 transition-all duration-500 hover:scale-110 z-10 cursor-pointer"
      />
