...
export default function Banner() {
  return (
    <section
      className={`bg-[url('assets/images/bg1.jpg')] bg-cover sm:bg-[length:100vw_100vh] aspect-[16/9] bg-no-repeat  text-white grid place-items-center py-20`}
    >
      <div className="max-w-4xl mx-auto text-center px-5 sm:px-0 space-y-3 sm:space-y-5">
        <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl py-0 my-0">Rent a car to move from local hosts in 190+ countries.</p>

        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold py-0 my-0">Make Your Ride Easy & Fast with Shift Ride Rental</h2>
